...
{
	/// <summary>
	/// Builds an in-memory DBContext to use for testing
	/// </summary>
	public static class TestDbContextBuilder
	{
		/// <summary>
		/// Constructs a new DBContext
		/// </summary>
		/// <returns></returns>
		public static IDatabaseContext Construct()
		{
			return new InMemoryPatientContext(GetPatients(), GetEpisodes());
		}
